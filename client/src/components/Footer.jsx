        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-400">
              ...
              <li><Link href="/leaderboard" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Hall of Fame Leaderboard</Link></li>
              <li><Link href="/help" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Help & Support Center</Link></li>
